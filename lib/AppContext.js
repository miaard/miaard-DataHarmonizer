...
export default class AppContext {
  ...
  refreshTabDisplay() {
    ...
    if (this.schemaEditor && class_name === 'Schema') {
    ...
    $('#slot_report_type, #slot_report_type option')
      .toggle(this.schemaEditor && class_name === 'Slot');
...
*/
  ...
  */
   ...
   * @return {Array} of rows, if any, each being an integer.
   */
   ...
   * FUTURE, allow value to be an array of permitted values.
