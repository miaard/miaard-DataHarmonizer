...
8. Run `yarn dev` to see a locally hosted test version
   ...
   - Check any new validation rules are enforced for new and/or updated terms by filling in both valid and invalid values and pressing 'Validate'
9.  Run `yarn build:web` to generate a distributable version in `web/dist`
